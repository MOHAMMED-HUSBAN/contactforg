...
const ContactUs = () => {
  ...
  return (
    ...
    >
      {/* About Us Section */}
      <div className="flex-1 text-white py-12 px-4 md:px-8 bg-black bg-opacity-5">
      ...
      <div className="flex-1 text-white py-12 px-4 md:px-8 bg-black bg-opacity-5 flex justify-center items-center">
        <div className="bg-gray-900 bg-opacity-5 p-6 rounded-lg shadow-lg w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="bg-sky-900 hover:bg-sky-700 text-white px-4 py-2 rounded-md w-full">Send Message</button>
          </form>
